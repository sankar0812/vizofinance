...
const roles = ['USER'];
const statusOptions = ['Active', 'Inactive', 'Lead'];
const repaymentModes = ['monthly', 'daily'];
...
const AddClientForm = () => {
  ...
  const handleChange = (e) => {
    ...
    setClient((prev) => {
      ...
      const { loanAmount, interestRate, loanTermMonths, loanTermDays, repaymentMode } = updated;

      if (loanAmount > 0 && interestRate > 0) {
        if (repaymentMode === 'monthly' && loanTermMonths > 0) {
          // Monthly EMI calc
          const P = loanAmount;
          ...
          const emi = P * r * Math.pow(1 + r, n) / (Math.pow(1 + r, n) - 1);
          const totalPayment = emi * n;
          updated.revenue = parseFloat((totalPayment - P).toFixed(2));
        } else if (repaymentMode === 'daily' && loanTermDays > 0) {
          // Simple daily model (like your LoanAmortization daily mode)
          const principalPerDay = loanAmount / loanTermDays;
          const interestPerDay = principalPerDay * (interestRate / 100); 
          const dailyPayment = principalPerDay + interestPerDay;
          const totalPayment = dailyPayment * loanTermDays;
          updated.revenue = parseFloat((totalPayment - loanAmount).toFixed(2));
        } else {
          updated.revenue = 0;
        }
      } else {
        ...
        <form id="add-client-form" onSubmit={handleSubmit}>
          <div className="container">
            <div className="row g-3">
              ...
              <div className="col-md-12">
                <TextField
                  required fullWidth size="small" label="Client Name"
                  name="name" value={client.name} onChange={handleChange}
                  InputProps={{ startAdornment: <InputAdornment position="start"><User size={16} /></InputAdornment> }}
                />
              </div>
              <div className="col-md-4">
                <TextField
                  required fullWidth size="small" label="Email"
                  name="email" value={client.email} onChange={handleChange}
              ...
              <div className="col-md-4">
                <TextField
                  ...
                  name="phone" value={client.phone} onChange={handleChange}
              ...
              <div className="col-md-4">
                <TextField
                  ...
                  name="address" value={client.address} onChange={handleChange}
                  ...
                  <DatePicker
                    ...
                    slotProps={{
                      textField: {
                        ...
                        InputProps: { startAdornment: <InputAdornment position="start"><CalendarIcon size={16} /></InputAdornment> }
                      },
                    }}
                  />
                </LocalizationProvider>
              ...
              <div className="col-md-4">
                <TextField
                  ...
                  name="status" value={client.status || 'Active'} onChange={handleChange}
                  InputProps={{ startAdornment: <InputAdornment position="start"><Briefcase size={16} /></InputAdornment> }}
                >
              ...
              <div className="col-md-4">
                <TextField
                  fullWidth size="small" type="number" label="Revenue"
                  name="revenue" value={client.revenue} onChange={handleChange}
                  InputProps={{ startAdornment: <InputAdornment position="start"><DollarSign size={16} /></InputAdornment> }}
                />
              </div>
              <div className="col-md-4">
                <TextField
                  fullWidth size="small" type="number" label="Transactions"
                  name="transactions" value={client.transactions} onChange={handleChange}
                  InputProps={{ startAdornment: <InputAdornment position="start"><FileText size={16} /></InputAdornment> }}
                />
              </div>
              <div className="col-md-4">
                <TextField
                  fullWidth size="small" type="number" label="Loan Amount"
                  name="loanAmount" value={client.loanAmount} onChange={handleChange}
                  InputProps={{ startAdornment: <InputAdornment position="start"><DollarSign size={16} /></InputAdornment> }}
                />
              </div>
              <div className="col-md-4">
                <TextField
                  fullWidth size="small" type="number" label="Interest Rate (%)"
                  name="interestRate" value={client.interestRate} onChange={handleChange}
                  InputProps={{ startAdornment: <InputAdornment position="start"><Percent size={16} /></InputAdornment> }}
                />
              </div>
              ...
              <div className="col-md-4">
                <TextField
                  select fullWidth size="small" label="Repayment Mode"
                  name="repaymentMode" value={client.repaymentMode} onChange={handleChange}
                  InputProps={{ startAdornment: <InputAdornment position="start"><Briefcase size={16} /></InputAdornment> }}
                >
              ...
              {/* Loan Term */}
              {client.repaymentMode === 'monthly' && (
                <div className="col-md-4">
                  <TextField
                    fullWidth size="small" type="number" label="Loan Term (Months)"
                    name="loanTermMonths" value={client.loanTermMonths} onChange={handleChange}
                    InputProps={{ startAdornment: <InputAdornment position="start"><Clock size={16} /></InputAdornment> }}
                  />
                </div>
              )}
              {client.repaymentMode === 'daily' && (
                <div className="col-md-4">
                  <TextField
                    fullWidth size="small" type="number" label="Loan Term (Days)"
                    name="loanTermDays" value={client.loanTermDays} onChange={handleChange}
                    InputProps={{ startAdornment: <InputAdornment position="start"><Clock size={16} /></InputAdornment> }}
                  />
                </div>
              )}
              ...
              <div className="col-md-4">
                <TextField
                  ...
                  name="role" value={client.role || 'USER'} onChange={handleChange}
                  InputProps={{ startAdornment: <InputAdornment position="start"><Briefcase size={16} /></InputAdornment> }}
                >
