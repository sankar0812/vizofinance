...
//             // Compute last payment date from paymentHistory if available
//             let lastPaymentDate = 'N/A';
//             if (Array.isArray(client.paymentHistory) && client.paymentHistory.length > 0) {
//               // Find the latest paymentDate
//               const sortedPayments = [...client.paymentHistory].sort(
//               (a, b) => new Date(b.paymentDate) - new Date(a.paymentDate)
//               );
//               lastPaymentDate = sortedPayments[0]?.paymentDate
//               ? new Date(sortedPayments[0].paymentDate).toLocaleDateString()
//               : 'N/A';
//             } else if (client?.lastPaymentDate && client.lastPaymentDate !== 'N/A') {
//               lastPaymentDate = new Date(client.lastPaymentDate).toLocaleDateString();
//             }
...
export default function LoanCalculationsPage({ customConfirm }) {
  ...
  const togglePaymentHistory = (clientId) => {
